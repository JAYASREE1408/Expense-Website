...
public class analytics {
   ...
   public Response get_by_user(@PathParam("id") int id){
		JSONObject result = new JSONObject();
	   try {				
		// select expense.sum(total) as total ,currency.name as currency from expense inner join currency on expense.id = currency.cid where expense.uid = ? group by currency.cid";
